...
public class TennisJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        buttonSearchMatch1 = new javax.swing.JButton();
        buttonSearch2Joueur2 = new javax.swing.JButton();
        jScrollPane4 = new javax.swing.JScrollPane();
        jTable4Epreuve = new javax.swing.JTable();
        ...
        buttonSearchMatch1.setBackground(new java.awt.Color(0, 153, 153));
        buttonSearchMatch1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        buttonSearchMatch1.setForeground(new java.awt.Color(255, 255, 255));
        buttonSearchMatch1.setText("Search");
        buttonSearchMatch1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonSearchMatch1ActionPerformed(evt);
            }
        });

        buttonSearch2Joueur2.setBackground(new java.awt.Color(153, 153, 153));
        buttonSearch2Joueur2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        buttonSearch2Joueur2.setForeground(new java.awt.Color(255, 255, 255));
        buttonSearch2Joueur2.setText("Clear");
        buttonSearch2Joueur2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonSearch2Joueur2ActionPerformed(evt);
            }
        });

        jTable4Epreuve.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane4.setViewportView(jTable4Epreuve);
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(buttonSearch2Joueur2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(buttonSearchMatch1, javax.swing.GroupLayout.DEFAULT_SIZE, 483, Short.MAX_VALUE))))
                .addContainerGap())
        );
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(buttonSearchMatch1, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(buttonSearch2Joueur2)
                .addGap(18, 18, 18)
    ...
    private void jTextField2KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField2KeyReleased
        ...
        try {
            String query = "SELECT * FROM tournoi WHERE id LIKE '%" + tf2 + "%' OR nom LIKE '%" + tf2 + "%' OR code LIKE '%" + tf2 + "%'";
    ...
    private void buttonSearchMatchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSearchMatchActionPerformed
        try {
            ...
            String id, nomVainqueur, nomFinaliste, sexe;

            while (rs.next()) {
                id = rs.getString(1);
                nomVainqueur = rs.getString(2);
                nomFinaliste = rs.getString(3);
                sexe = rs.getString(4);
                String[] row = {id, nomVainqueur, nomFinaliste, sexe};
                model.addRow(row);
            }
    ...
    private void jTextField3KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField3KeyReleased
        ...
        try {
            String query = """
                           ...
                           INNER JOIN JOUEUR J ON J.ID = mt.ID_VAINQUEUR
                           INNER JOIN JOUEUR J1 ON J1.ID = mt.ID_FINALISTE
                           WHERE J.NOM LIKE '%""" + tf + "%' OR J.PRENOM LIKE '%" + tf + "%' OR J1.NOM LIKE '%" + tf + "%' OR J1.PRENOM LIKE '%" + tf + "%' OR mt.ID LIKE '%" + tf + "%' "
                    + "ORDER BY ID";
    ...
    private void jTextField4KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField4KeyReleased
        ...
        try {
            String query = "SELECT e.ID , CONCAT(j.PRENOM, ' ', j.NOM) as Joueur, e.TYPE_EPREUVE as Epreuves, e.ANNEE, t.NOM AS TOURNOI,\r\n"
                    ...
                    + "WHERE J.NOM LIKE '%" + tf + "%' OR J.PRENOM LIKE '%" + tf + "%' OR e.ANNEE LIKE '%" + tf + "%' OR e.ID LIKE '%" + tf + "%' OR t.nom LIKE '%" + tf + "%' OR m.ID_VAINQUEUR LIKE '%" + tf + "%' OR j.ID LIKE '%" + tf + "%'"
                    + "ORDER BY e.ANNEE DESC";

            pst = con.prepareStatement(query);
            rs = pst.executeQuery();
            jTable4Epreuve.setModel(DbUtils.resultSetToTableModel(rs));
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, e);
        }
    }//GEN-LAST:event_jTextField4KeyReleased

    private void buttonSearchMatch1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSearchMatch1ActionPerformed
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            con = DriverManager.getConnection(jdbcURL, username, password);
            ...
            String query
                    = "SELECT e.ID , CONCAT(j.PRENOM, ' ', j.NOM) AS Joueur, e.TYPE_EPREUVE as Epreuves, e.ANNEE, t.NOM AS TOURNOI,\r\n"
                    + "IF(m.ID_VAINQUEUR=j.ID, 'vainqueur', 'finaliste') AS STATUT\r\n"
                    + "FROM JOUEUR j\r\n"
                    + "JOIN MATCH_TENNIS m ON j.ID = m.ID_VAINQUEUR OR j.ID = m.ID_FINALISTE\r\n"
                    + "JOIN EPREUVE e ON m.ID_EPREUVE = e.ID\r\n"
            ...
            ResultSet rs = st.executeQuery(query);
            ResultSetMetaData rsmd = rs.getMetaData();
            DefaultTableModel model = (DefaultTableModel) jTable4Epreuve.getModel();
            ...
            String id, joueur, epreuve, annee, tournoi, statut;

            while (rs.next()) {
                id = rs.getString(1);
                joueur = rs.getString(2);
                epreuve = rs.getString(3);
                annee = rs.getString(4);
                tournoi = rs.getString(5);
                statut = rs.getString(6);

                String[] row = {id, joueur, epreuve, annee, tournoi, statut};
                model.addRow(row);
            }
    ...
    }//GEN-LAST:event_buttonSearchMatch1ActionPerformed

    private void buttonSearch2Joueur2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSearch2Joueur2ActionPerformed
        jTable4Epreuve.setModel(new DefaultTableModel());
    }//GEN-LAST:event_buttonSearch2Joueur2ActionPerformed
    ...
    private javax.swing.JButton buttonSearch2Joueur2;
    private javax.swing.JButton buttonSearchJoueur;
    private javax.swing.JButton buttonSearchMatch;
    private javax.swing.JButton buttonSearchMatch1;
    ...
    private javax.swing.JTable jTable4Epreuve;
